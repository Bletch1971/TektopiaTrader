...
public class CommandTraderKill extends CommandTraderBase {
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if (entityList.size() == 0) {
			notifyCommandListener(sender, this, TraderCommands.COMMAND_PREFIX + COMMAND_NAME + ".noexists", new Object[0]);
			LoggerUtils.info(TextUtils.translate(TraderCommands.COMMAND_PREFIX + COMMAND_NAME + ".noexists", new Object[0]), true);
			return;
        }
        ...
        for (EntityTrader entity : entityList) {
    		...
    		notifyCommandListener(sender, this, TraderCommands.COMMAND_PREFIX + COMMAND_NAME + ".success", new Object[] { name });
    		LoggerUtils.info(TextUtils.translate(TraderCommands.COMMAND_PREFIX + COMMAND_NAME + ".success", new Object[] { name }), true);
        }
	}
