...
import bletch.tektopiatrader.TektopiaTrader;
...
public class LoggerUtils {
    ...
    private static final File debugFile = new File(TektopiaTrader.proxy.getMinecraftDirectory() + ModDetails.FILE_DEBUGLOG);
