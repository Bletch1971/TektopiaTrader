...
public class ModConfig {
	...
	@Config.LangKey("config.banker")
	public static final Banker banker = new Banker();
	...
	public static class Banker {
		...
		@Config.Comment("The list of trade items for the banker, each trade item is worth 1 emerald. Must be in the format <modid>:<item/block>*<quantity> (Eg. minecraft:iron_ingot*64)")
		@Config.LangKey("config.banker.trades")
		public String[] bankerTrades = new String[] {"minecraft:iron_ingot*64", "minecraft:gold_ingot*32", "minecraft:diamond*8", "minecraft:redstone_block*16", "minecraft:lapis_block*16"};
		
		@Config.Comment("If true, the banker will only exist during the day time, and will despawn during night time.")
		@Config.LangKey("config.banker.dayTimeOnly")
		public boolean dayTimeOnly = true;	
